...
const pageTitles = {
  it: {
    ...
    '/verifica-checkvan': 'Verifica PDF CheckVan | DTO Solution',
    '/confronta-checkvan': 'Confronta ispezioni CheckVan | DTO Solution',
  ...
  en: {
    ...
    '/verifica-checkvan': 'Verify CheckVan PDF | DTO Solution',
    '/confronta-checkvan': 'Compare CheckVan inspections | DTO Solution',
    '/software/observa-poker': 'Observa Poker | Software',
