...
const pageTitles = {
  it: {
    ...
    '/area-driver/accordo-asso-espressi-ultimo-miglio-2025': 'Accordo Assoespressi 2025 ultimo miglio | Area Driver DTO Solution',
  ...
  en: {
    ...
    '/area-driver/accordo-asso-espressi-ultimo-miglio-2025': 'Assoespressi 2025 last-mile agreement | DTO Solution',
    '/applicazioni/checkvan-pro': 'CheckVan Pro | DTO Solution',
