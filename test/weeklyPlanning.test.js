...
import { sortDrivers, driverSummary, dailySummary, filterDrivers, findConflicts, resolveEffective, copyPreviousWeek, propagatePlannedVehicle, weekStart, weekDays, shiftDay, validDate, entryKey, resolveRoute, latestPreviousWeeklyVehicle, weeklyFormVehicle } from '../company/src/lib/weeklyPlanning.js'
...
test('a new weekly shift form uses the latest previous planned vehicle without replacing manual choices', () => {
  const entries = [entry('a', '2026-09-07', 'v1'), entry('a', '2026-09-10', 'v2'), entry('a', '2026-09-11', 'v2'), entry('b', '2026-09-08', 'v3'), entry('a', '2026-09-09', null, 'FERIE')]
  assert.equal(latestPreviousWeeklyVehicle(entries, 'a', '2026-09-12'), 'v2')
  assert.equal(latestPreviousWeeklyVehicle(entries, 'a', '2026-09-10'), 'v1')
  assert.equal(latestPreviousWeeklyVehicle(entries, 'b', '2026-09-08'), '')
  assert.equal(latestPreviousWeeklyVehicle(entries, 'missing', '2026-09-12'), '')
