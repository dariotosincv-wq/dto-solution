...
begin
 ...
 -- A TURNO added after the default vehicle inherits it, while manual changes stay local.
 result := public.internal_admin_mutate_weekly_plan(actor,org,jsonb_build_object('action','SAVE','week_start','2030-01-14','assignment_date','2030-01-14','revision',2,'driver_id',driver,'vehicle_id',vehicle,'work_status','TURNO'));
 result := public.internal_admin_mutate_weekly_plan(actor,org,jsonb_build_object('action','SAVE','week_start','2030-01-14','assignment_date','2030-01-16','revision',3,'driver_id',driver,'vehicle_id',null,'work_status','TURNO'));
